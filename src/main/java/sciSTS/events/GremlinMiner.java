...
public class GremlinMiner extends AbstractImageEvent {
    public static final String ID = "event.GrimlinMiner";
    ...
    public GremlinMiner() {
        super(NAME, DESCRIPTIONS[0], "SciSTSResources/images/events/miner.jpg");
        this.screen = Screen.INTRO;
        this.imageEventText.setDialogOption(OPTIONS[0]);
        this.img = ImageMaster.loadImage(("SciSTSResources/images/ui/miner.png"));
