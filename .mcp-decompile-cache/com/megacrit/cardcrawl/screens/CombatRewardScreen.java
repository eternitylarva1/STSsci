...
public class CombatRewardScreen {
    ...
    public void setupItemReward() {
        ...
        if (!(AbstractDungeon.getCurrRoom().event != null && (AbstractDungeon.getCurrRoom().event == null || AbstractDungeon.getCurrRoom().event.noCardsInRewards) || AbstractDungeon.getCurrRoom() instanceof TreasureRoom || AbstractDungeon.getCurrRoom() instanceof RestRoom)) {
            if (ModHelper.isModEnabled((String)"Vintage") && AbstractDungeon.getCurrRoom() instanceof MonsterRoom) {
    ...
    private void rewardViewUpdate() {
        ...
        this.tipY = MathHelper.uiLerpSnap((float)this.tipY, (float)((float)Settings.HEIGHT / 2.0f - 460.0f * Settings.scale));
    ...
    private void setLabel() {
        if (this.rewards.size() == 0) {
            ...
            switch (1.$SwitchMap$com$megacrit$cardcrawl$rewards$RewardItem$RewardType[this.rewards.get((int)0).type.ordinal()]) {
                case 1: {
    ...
    public void render(SpriteBatch sb) {
        ...
        FontHelper.renderFontCentered((SpriteBatch)sb, (BitmapFont)FontHelper.panelNameFont, (String)(TEXT[12] + this.tip), (float)((float)Settings.WIDTH / 2.0f), (float)this.tipY, (Color)Color.LIGHT_GRAY);
    ...
    public void open(String setLabel) {
        ...
        for (RewardItem r : this.rewards) {
            ...
            UnlockTracker.markRelicAsSeen((String)r.relic.relicId);
        }
    }
    ...
    private String getRandomBannerLabel() {
        ...
        return (String)list.get(MathUtils.random((int)(list.size() - 1)));
    }
