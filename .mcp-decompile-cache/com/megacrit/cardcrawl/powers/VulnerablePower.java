...
extends AbstractPower {
    ...
    public void atEndOfRound() {
        ...
        if (this.amount == 0) {
            this.addToBot((AbstractGameAction)new RemoveSpecificPowerAction(this.owner, this.owner, POWER_ID));
        } else {
            this.addToBot((AbstractGameAction)new ReducePowerAction(this.owner, this.owner, POWER_ID, 1));
        }
    }
