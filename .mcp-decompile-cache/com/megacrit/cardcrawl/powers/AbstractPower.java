 ...
 *  com.megacrit.cardcrawl.vfx.combat.FlashPowerEffect
 *  com.megacrit.cardcrawl.vfx.combat.GainPowerEffect
 *  com.megacrit.cardcrawl.vfx.combat.SilentGainPowerEffect
...
implements Comparable<AbstractPower> {
    private static final Logger logger = LogManager.getLogger((String)AbstractPower.class.getName());
    ...
    public void playApplyPowerSfx() {
        if (this.type == PowerType.BUFF) {
            int roll = MathUtils.random((int)0, (int)2);
            if (roll == 0) {
    ...
    private void updateColor() {
        if (this.color.a != 1.0f) {
            this.color.a = MathHelper.fadeLerpSnap((float)this.color.a, (float)1.0f);
        }
    }

    private void updateFontScale() {
        if (this.fontScale != 1.0f) {
            this.fontScale = MathUtils.lerp((float)this.fontScale, (float)1.0f, (float)(Gdx.graphics.getDeltaTime() * 10.0f));
    ...
    public void renderIcons(SpriteBatch sb, float x, float y, Color c) {
        if (this.img != null) {
            ...
            if (Settings.isMobile) {
                sb.draw((TextureRegion)this.region48, x - (float)this.region48.packedWidth / 2.0f, y - (float)this.region48.packedHeight / 2.0f, (float)this.region48.packedWidth / 2.0f, (float)this.region48.packedHeight / 2.0f, (float)this.region48.packedWidth, (float)this.region48.packedHeight, Settings.scale * 1.17f, Settings.scale * 1.17f, 0.0f);
            } else {
                sb.draw((TextureRegion)this.region48, x - (float)this.region48.packedWidth / 2.0f, y - (float)this.region48.packedHeight / 2.0f, (float)this.region48.packedWidth / 2.0f, (float)this.region48.packedHeight / 2.0f, (float)this.region48.packedWidth, (float)this.region48.packedHeight, Settings.scale, Settings.scale, 0.0f);
            }
        }
    ...
    public void renderAmount(SpriteBatch sb, float x, float y, Color c) {
        if (this.amount > 0) {
            ...
            FontHelper.renderFontRightTopAligned((SpriteBatch)sb, (BitmapFont)FontHelper.powerAmountFont, (String)Integer.toString(this.amount), (float)x, (float)y, (float)this.fontScale, (Color)c);
    ...
    public void flash() {
        this.effect.add((AbstractGameEffect)new GainPowerEffect(this));
        AbstractDungeon.effectList.add((AbstractGameEffect)new FlashPowerEffect(this));
    }

    public void flashWithoutSound() {
        this.effect.add((AbstractGameEffect)new SilentGainPowerEffect(this));
        AbstractDungeon.effectList.add((AbstractGameEffect)new FlashPowerEffect(this));
    }
