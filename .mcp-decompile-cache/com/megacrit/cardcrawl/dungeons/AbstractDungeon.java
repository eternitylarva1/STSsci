 ...
 *  com.megacrit.cardcrawl.cards.CardGroup$CardGroupType
 *  com.megacrit.cardcrawl.cards.SoulGroup
 *  com.megacrit.cardcrawl.cards.colorless.SwiftStrike
 *  com.megacrit.cardcrawl.cards.curses.AscendersBane
 ...
 *  com.megacrit.cardcrawl.dungeons.AbstractDungeon$RenderScene
 ...
 *  com.megacrit.cardcrawl.helpers.EventHelper$RoomResult
 *  com.megacrit.cardcrawl.helpers.ImageMaster
 *  com.megacrit.cardcrawl.helpers.MathHelper
 ...
 *  com.megacrit.cardcrawl.helpers.SaveHelper
 *  com.megacrit.cardcrawl.helpers.TipTracker
 *  com.megacrit.cardcrawl.helpers.controller.CInputActionSet
 *  com.megacrit.cardcrawl.helpers.input.InputHelper
 *  com.megacrit.cardcrawl.localization.UIStrings
 ...
 *  com.megacrit.cardcrawl.metrics.Metrics$MetricRequestType
 ...
 *  com.megacrit.cardcrawl.neow.NeowUnlockScreen
 ...
 *  com.megacrit.cardcrawl.rewards.chests.LargeChest
 *  com.megacrit.cardcrawl.rewards.chests.MediumChest
 *  com.megacrit.cardcrawl.rewards.chests.SmallChest
 ...
 *  com.megacrit.cardcrawl.rooms.VictoryRoom
 *  com.megacrit.cardcrawl.rooms.VictoryRoom$EventType
 *  com.megacrit.cardcrawl.saveAndContinue.SaveAndContinue
 *  com.megacrit.cardcrawl.saveAndContinue.SaveFile
 *  com.megacrit.cardcrawl.saveAndContinue.SaveFile$SaveType
 *  com.megacrit.cardcrawl.scenes.AbstractScene
 ...
 *  com.megacrit.cardcrawl.screens.DiscardPileViewScreen
 ...
 *  com.megacrit.cardcrawl.screens.MasterDeckViewScreen
 *  com.megacrit.cardcrawl.screens.VictoryScreen
 *  com.megacrit.cardcrawl.screens.options.InputSettingsScreen
 ...
 *  com.megacrit.cardcrawl.ui.FtueTip
 *  com.megacrit.cardcrawl.ui.buttons.DynamicBanner
 *  com.megacrit.cardcrawl.ui.buttons.PeekButton
 *  com.megacrit.cardcrawl.ui.panels.TopPanel
 *  com.megacrit.cardcrawl.unlock.AbstractUnlock
 ...
 *  com.megacrit.cardcrawl.vfx.ObtainKeyEffect
 *  com.megacrit.cardcrawl.vfx.PlayerTurnEffect
...
public abstract class AbstractDungeon {
    protected static final Logger logger = LogManager.getLogger((String)AbstractDungeon.class.getName());
    ...
    public AbstractDungeon(String name, String levelId, AbstractPlayer p, ArrayList<String> newSpecialOneTimeEventList) {
        ascensionCheck = UnlockTracker.isAscensionUnlocked((AbstractPlayer)p);
    ...
    public AbstractDungeon(String name, AbstractPlayer p, SaveFile saveFile) {
        ...
        try {
            ...
            SaveAndContinue.deleteSave((AbstractPlayer)player);
            ExceptionHandler.handleException((Exception)e, (Logger)LOGGER);
            Gdx.app.exit();
        }
        this.initializeEventImg();
        this.initializeShrineList();
    ...
    private void setBoss(String key) {
        ...
        if (key.equals("The Guardian")) {
            DungeonMap.boss = ImageMaster.loadImage((String)"images/ui/map/boss/guardian.png");
            DungeonMap.bossOutline = ImageMaster.loadImage((String)"images/ui/map/bossOutline/guardian.png");
        } else if (key.equals("Hexaghost")) {
            DungeonMap.boss = ImageMaster.loadImage((String)"images/ui/map/boss/hexaghost.png");
            DungeonMap.bossOutline = ImageMaster.loadImage((String)"images/ui/map/bossOutline/hexaghost.png");
        } else if (key.equals("Slime Boss")) {
            DungeonMap.boss = ImageMaster.loadImage((String)"images/ui/map/boss/slime.png");
            DungeonMap.bossOutline = ImageMaster.loadImage((String)"images/ui/map/bossOutline/slime.png");
        } else if (key.equals("Collector")) {
            DungeonMap.boss = ImageMaster.loadImage((String)"images/ui/map/boss/collector.png");
            DungeonMap.bossOutline = ImageMaster.loadImage((String)"images/ui/map/bossOutline/collector.png");
        } else if (key.equals("Automaton")) {
            DungeonMap.boss = ImageMaster.loadImage((String)"images/ui/map/boss/automaton.png");
            DungeonMap.bossOutline = ImageMaster.loadImage((String)"images/ui/map/bossOutline/automaton.png");
        } else if (key.equals("Champ")) {
            DungeonMap.boss = ImageMaster.loadImage((String)"images/ui/map/boss/champ.png");
            DungeonMap.bossOutline = ImageMaster.loadImage((String)"images/ui/map/bossOutline/champ.png");
        } else if (key.equals("Awakened One")) {
            DungeonMap.boss = ImageMaster.loadImage((String)"images/ui/map/boss/awakened.png");
            DungeonMap.bossOutline = ImageMaster.loadImage((String)"images/ui/map/bossOutline/awakened.png");
        } else if (key.equals("Time Eater")) {
            DungeonMap.boss = ImageMaster.loadImage((String)"images/ui/map/boss/timeeater.png");
            DungeonMap.bossOutline = ImageMaster.loadImage((String)"images/ui/map/bossOutline/timeeater.png");
        } else if (key.equals("Donu and Deca")) {
            DungeonMap.boss = ImageMaster.loadImage((String)"images/ui/map/boss/donu.png");
            DungeonMap.bossOutline = ImageMaster.loadImage((String)"images/ui/map/bossOutline/donu.png");
        } else if (key.equals("The Heart")) {
            DungeonMap.boss = ImageMaster.loadImage((String)"images/ui/map/boss/heart.png");
            DungeonMap.bossOutline = ImageMaster.loadImage((String)"images/ui/map/bossOutline/heart.png");
        } else {
    ...
    public static void loadSeeds(SaveFile save) {
        if (save.is_daily || save.is_trial) {
            ...
            if (save.is_daily) {
                ModHelper.setTodaysMods((long)save.special_seed, (AbstractPlayer.PlayerClass)AbstractDungeon.player.chosenClass);
            } else {
                ModHelper.setTodaysMods((long)save.seed, (AbstractPlayer.PlayerClass)AbstractDungeon.player.chosenClass);
            }
        }
    ...
    protected static void generateMap() {
        ...
        map = MapGenerator.generateDungeon((int)mapHeight, (int)mapWidth, (int)mapPathDensity, (Random)mapRng);
        int count = 0;
        ...
        map = RoomTypeAssigner.distributeRoomsAcrossMap((Random)mapRng, map, roomList);
    ...
    private static void generateRoomTypes(ArrayList<AbstractRoom> roomList, int availableRoomCount) {
        ...
        if (ModHelper.isModEnabled((String)"Elite Swarm")) {
        ...
        for (i = 0; i < shopCount; ++i) {
            roomList.add((AbstractRoom)new ShopRoom());
        }
        for (i = 0; i < restCount; ++i) {
            roomList.add((AbstractRoom)new RestRoom());
        }
        for (i = 0; i < eliteCount; ++i) {
            roomList.add((AbstractRoom)new MonsterRoomElite());
        }
        for (i = 0; i < eventCount; ++i) {
            roomList.add((AbstractRoom)new EventRoom());
        }
    }
    ...
    public static AbstractRelic returnRandomRelic(AbstractRelic.RelicTier tier) {
        ...
        return RelicLibrary.getRelic((String)AbstractDungeon.returnRandomRelicKey(tier)).makeCopy();
    }

    public static AbstractRelic returnRandomScreenlessRelic(AbstractRelic.RelicTier tier) {
        logger.info("Returning " + tier.name() + " relic");
        AbstractRelic tmpRelic = RelicLibrary.getRelic((String)AbstractDungeon.returnRandomRelicKey(tier)).makeCopy();
        while (Objects.equals(tmpRelic.relicId, "Bottled Flame") || Objects.equals(tmpRelic.relicId, "Bottled Lightning") || Objects.equals(tmpRelic.relicId, "Bottled Tornado") || Objects.equals(tmpRelic.relicId, "Whetstone")) {
            tmpRelic = RelicLibrary.getRelic((String)AbstractDungeon.returnRandomRelicKey(tier)).makeCopy();
        }
        return tmpRelic;
    }
    ...
    public static AbstractRelic returnRandomRelicEnd(AbstractRelic.RelicTier tier) {
        logger.info("Returning " + tier.name() + " relic");
        return RelicLibrary.getRelic((String)AbstractDungeon.returnEndRandomRelicKey(tier)).makeCopy();
    }

    public static String returnEndRandomRelicKey(AbstractRelic.RelicTier tier) {
        String retVal = null;
        switch (1.$SwitchMap$com$megacrit$cardcrawl$relics$AbstractRelic$RelicTier[tier.ordinal()]) {
            case 1: {
        ...
        if (!RelicLibrary.getRelic((String)retVal).canSpawn()) {
    ...
    public static void transformCard(AbstractCard c, boolean autoUpgrade, Random rng) {
        switch (1.$SwitchMap$com$megacrit$cardcrawl$cards$AbstractCard$CardColor[c.color.ordinal()]) {
            case 1: {
                transformedCard = AbstractDungeon.returnTrulyRandomColorlessCardFromAvailable(c, rng).makeCopy();
                break;
            }
            case 2: {
                transformedCard = CardLibrary.getCurse((AbstractCard)c, (Random)rng).makeCopy();
                break;
            }
            default: {
        ...
        UnlockTracker.markCardAsSeen((String)AbstractDungeon.transformedCard.cardID);
    ...
    public static void srcTransformCard(AbstractCard c) {
        ...
        switch (1.$SwitchMap$com$megacrit$cardcrawl$cards$AbstractCard$CardRarity[c.rarity.ordinal()]) {
            case 1: {
    ...
    public static AbstractCard returnTrulyRandomCardInCombat() {
        ...
        for (AbstractCard c : AbstractDungeon.srcCommonCardPool.group) {
            ...
            list.add(c);
            UnlockTracker.markCardAsSeen((String)c.cardID);
        }
    ...
    public static AbstractCard returnTrulyRandomCardFromAvailable(AbstractCard prohibited, Random rng) {
        ArrayList<AbstractCard> list = new ArrayList<AbstractCard>();
        switch (1.$SwitchMap$com$megacrit$cardcrawl$cards$AbstractCard$CardColor[prohibited.color.ordinal()]) {
            case 1: {
    ...
    public void populateFirstStrongEnemy(ArrayList<MonsterInfo> monsters, ArrayList<String> exclusions) {
        String m;
        while (exclusions.contains(m = MonsterInfo.roll(monsters, (float)monsterRng.random()))) {
        }
        monsterList.add(m);
    }
        ...
        if (elites) {
            for (int i = 0; i < numMonsters; ++i) {
                if (eliteMonsterList.isEmpty()) {
                    eliteMonsterList.add(MonsterInfo.roll(monsters, (float)monsterRng.random()));
                    continue;
                }
                String toAdd = MonsterInfo.roll(monsters, (float)monsterRng.random());
            ...
            for (int i = 0; i < numMonsters; ++i) {
                if (monsterList.isEmpty()) {
                    monsterList.add(MonsterInfo.roll(monsters, (float)monsterRng.random()));
                    continue;
                }
                String toAdd = MonsterInfo.roll(monsters, (float)monsterRng.random());
    ...
    public void initializePotions() {
        PotionHelper.initialize((AbstractPlayer.PlayerClass)AbstractDungeon.player.chosenClass);
    }
    ...
    public void initializeCardPools() {
        ...
        if (ModHelper.isModEnabled((String)"Colorless Cards")) {
            CardLibrary.addColorlessCards(tmpPool);
        }
        if (ModHelper.isModEnabled((String)"Diverse")) {
            CardLibrary.addRedCards(tmpPool);
            CardLibrary.addGreenCards(tmpPool);
            CardLibrary.addBlueCards(tmpPool);
            if (!UnlockTracker.isCharacterLocked((String)"Watcher")) {
    ...
    protected void initializeRelicList() {
        ...
        shopRelicPool.clear();
        bossRelicPool.clear();
        RelicLibrary.populateRelicPool(commonRelicPool, (AbstractRelic.RelicTier)AbstractRelic.RelicTier.COMMON, (AbstractPlayer.PlayerClass)AbstractDungeon.player.chosenClass);
        RelicLibrary.populateRelicPool(uncommonRelicPool, (AbstractRelic.RelicTier)AbstractRelic.RelicTier.UNCOMMON, (AbstractPlayer.PlayerClass)AbstractDungeon.player.chosenClass);
        RelicLibrary.populateRelicPool(rareRelicPool, (AbstractRelic.RelicTier)AbstractRelic.RelicTier.RARE, (AbstractPlayer.PlayerClass)AbstractDungeon.player.chosenClass);
        RelicLibrary.populateRelicPool(shopRelicPool, (AbstractRelic.RelicTier)AbstractRelic.RelicTier.SHOP, (AbstractPlayer.PlayerClass)AbstractDungeon.player.chosenClass);
        RelicLibrary.populateRelicPool(bossRelicPool, (AbstractRelic.RelicTier)AbstractRelic.RelicTier.BOSS, (AbstractPlayer.PlayerClass)AbstractDungeon.player.chosenClass);
        if (floorNum >= 1) {
        ...
        if (ModHelper.isModEnabled((String)"Flight") || ModHelper.isModEnabled((String)"Uncertain Future")) {
            relicsToRemoveOnStart.add("WingedGreaves");
        }
        if (ModHelper.isModEnabled((String)"Diverse")) {
            relicsToRemoveOnStart.add("PrismaticShard");
        }
        if (ModHelper.isModEnabled((String)"DeadlyEvents")) {
            relicsToRemoveOnStart.add("Juzu Bracelet");
        }
        if (ModHelper.isModEnabled((String)"Hoarder")) {
            relicsToRemoveOnStart.add("Smiling Mask");
        }
        if (ModHelper.isModEnabled((String)"Draft") || ModHelper.isModEnabled((String)"SealedDeck") || ModHelper.isModEnabled((String)"Shiny") || ModHelper.isModEnabled((String)"Insanity")) {
    ...
    public static ArrayList<AbstractCard> getColorlessRewardCards() {
        ...
        if (ModHelper.isModEnabled((String)"Binary")) {
            --numCards;
        }
        for (int i = 0; i < numCards; ++i) {
            AbstractCard.CardRarity rarity = AbstractDungeon.rollRareOrUncommon(colorlessRareChance);
            AbstractCard card = null;
            switch (1.$SwitchMap$com$megacrit$cardcrawl$cards$AbstractCard$CardRarity[rarity.ordinal()]) {
                case 4: {
    ...
    public static ArrayList<AbstractCard> getRewardCards() {
        ...
        for (int i = 0; i < numCards; ++i) {
            ...
            block7: while (containsDupe) {
                containsDupe = false;
                card = player.hasRelic("PrismaticShard") ? CardLibrary.getAnyColorCard((AbstractCard.CardRarity)rarity) : AbstractDungeon.getCard(rarity);
                for (AbstractCard c : retVal) {
    ...
    public static void nextRoomTransitionStart() {
        ...
        if (ModHelper.isModEnabled((String)"Terminal")) {
        ...
        if (AbstractDungeon.currMapNode.room instanceof MonsterRoom) {
            if (!CardCrawlGame.loadingSave) {
                if (SaveHelper.shouldSave()) {
                    SaveHelper.saveIfAppropriate((SaveFile.SaveType)SaveFile.SaveType.ENTER_ROOM);
                } else {
    ...
    public void nextRoomTransition(SaveFile saveFile) {
        ...
        if (!CardCrawlGame.loadingSave) {
            ...
            if (!((Boolean)TipTracker.tips.get("INTENT_TIP")).booleanValue() && ++floorNum == 6) {
                TipTracker.neverShowAgain((String)"INTENT_TIP");
            }
            StatsScreen.incrementFloorClimbed();
            SaveHelper.saveIfAppropriate((SaveFile.SaveType)SaveFile.SaveType.ENTER_ROOM);
        }
        monsterHpRng = new Random(Long.valueOf(Settings.seed + (long)floorNum));
        aiRng = new Random(Long.valueOf(Settings.seed + (long)floorNum));
        shuffleRng = new Random(Long.valueOf(Settings.seed + (long)floorNum));
        cardRandomRng = new Random(Long.valueOf(Settings.seed + (long)floorNum));
        miscRng = new Random(Long.valueOf(Settings.seed + (long)floorNum));
        ...
        if (nextRoom != null) {
            ...
            if (AbstractDungeon.nextRoom.room instanceof EventRoom) {
                ...
                EventHelper.RoomResult roomResult = EventHelper.roll((Random)eventRngDuplicate);
        ...
        if (isLoadingCompletedEvent) {
            ...
            ((EventRoom)AbstractDungeon.getCurrRoom()).event = EventHelper.getEvent((String)eventKey);
        } else {
            if (isAscensionMode) {
    ...
    private AbstractRoom generateRoom(EventHelper.RoomResult roomType) {
        ...
        switch (1.$SwitchMap$com$megacrit$cardcrawl$helpers$EventHelper$RoomResult[roomType.ordinal()]) {
            case 1: {
    ...
    public static AbstractEvent getShrine(Random rng) {
        ...
        return EventHelper.getEvent((String)tmpKey);
    }
    ...
    public MonsterGroup getBoss() {
        ...
        return MonsterHelper.getEncounter((String)bossKey);
    }
    ...
    public void update() {
        ...
        if (isScreenUp) {
            AbstractDungeon.topGradientColor.a = MathHelper.fadeLerpSnap((float)AbstractDungeon.topGradientColor.a, (float)0.25f);
            AbstractDungeon.botGradientColor.a = MathHelper.fadeLerpSnap((float)AbstractDungeon.botGradientColor.a, (float)0.25f);
        } else {
            AbstractDungeon.topGradientColor.a = MathHelper.fadeLerpSnap((float)AbstractDungeon.topGradientColor.a, (float)0.1f);
            AbstractDungeon.botGradientColor.a = MathHelper.fadeLerpSnap((float)AbstractDungeon.botGradientColor.a, (float)0.1f);
        }
        switch (1.$SwitchMap$com$megacrit$cardcrawl$dungeons$AbstractDungeon$CurrentScreen[screen.ordinal()]) {
            case 1: 
            case 2: {
    ...
    public void render(SpriteBatch sb) {
        AbstractRoom room;
        switch (1.$SwitchMap$com$megacrit$cardcrawl$dungeons$AbstractDungeon$RenderScene[rs.ordinal()]) {
            case 1: {
    ...
    private static void openPreviousScreen(CurrentScreen s) {
        switch (1.$SwitchMap$com$megacrit$cardcrawl$dungeons$AbstractDungeon$CurrentScreen[s.ordinal()]) {
            case 17: {
                deathScreen.reopen();
                break;
            }
    ...
    public static void dungeonTransitionSetup() {
        ...
        if (ascensionLevel >= 5) {
            player.heal(MathUtils.round((float)((float)(AbstractDungeon.player.maxHealth - AbstractDungeon.player.currentHealth) * 0.75f)), false);
        } else {
        ...
        if (floorNum <= 1 && CardCrawlGame.dungeon instanceof Exordium) {
            ...
            if (ascensionLevel >= 6) {
                AbstractDungeon.player.currentHealth = MathUtils.round((float)((float)AbstractDungeon.player.maxHealth * 0.9f));
            }
            if (ascensionLevel >= 10) {
                AbstractDungeon.player.masterDeck.addToTop((AbstractCard)new AscendersBane());
                UnlockTracker.markCardAsSeen((String)"AscendersBane");
            }
    ...
    public void checkForPactAchievement() {
        if (player != null && AbstractDungeon.player.exhaustPile.size() >= 20) {
            UnlockTracker.unlockAchievement((String)"THE_PACT");
        }
    }
    ...
    public void loadSave(SaveFile saveFile) {
        ...
        EventHelper.setChances((ArrayList)saveFile.event_chances);
        ...
        if (saveFile.daily_mods != null) {
            ModHelper.setMods((List)saveFile.daily_mods);
        }
    }
    ...
    static {
        ...
        LOGGER = LogManager.getLogger((String)AbstractDungeon.class.getName());
    }
}
