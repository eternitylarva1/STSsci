# Spine/Dragonbones Animations (Game Native) (by [Subcouture](https://github.com/subcouture))

**Spine** is the toolkit Megacrit used to create their animations, and thus Spine has the best support within the game engine, with a smaller performance hit compared to both of the options below. However, a license for Spine costs USD99, which is a little outside what most people would like to spend on their Slay the Spire mod. If you already own it for some reason, great! But for the the rest of us, there's **Dragonbones**, which exports to Spine format. **[Grab it here.](https://docs.egret.com/dragonbones/en)** ([Dragonbones is on github too!](https://github.com/DragonBones))

Dragonbones is primarily designed for skeletal animation, just like Spine and Spriter, however you can [work in support for sprite animations as well](http://getting-started-dragonbones.blogspot.com/2018/12/how-to-animate-sequence-of-png.html). Either way, make sure you select armature template when creating your new project - then make your magic!

![Image example of selecting the armature template](https://i.imgur.com/u1qhbK7.png)
...
![Curve with multiple points](https://i.imgur.com/OcYJn2C.png)
...
![Image example of the recommended settings for Dragonbones Export](https://i.imgur.com/eHkQRdm.png)
...
To actually get your animation in game, just like Spriter below, in the constructor for your class **extending** `CustomPlayer` you will call `super()` using the `CustomPlayer` constructor - inserting the relevant data for your custom character. 

![Example of custom character constructor](https://i.imgur.com/bMgWBNz.png)
...
# Spriter Animations (by https://github.com/kiooeht)
